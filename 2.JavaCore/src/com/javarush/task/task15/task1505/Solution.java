...
public class Solution {
    ...
    public static class BodyPart implements LivingPart {
        ...
        public String toString() {
            String bones = "";
            if (containsBones().equals("Yes")) bones = name + " содержит кости";
            else bones = name + " не содержит кости";
...
//        }
    ...
    private static void printlnLivingParts() {
        System.out.println(new BodyPart("Рука").containsBones()); //рука костянная
    }
